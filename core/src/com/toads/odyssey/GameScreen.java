...
//
//        float playerX = player.getSpritePosition().x;
//        int mapHeightInTiles = 20;
//        int tileSize = 16;
//        float mapCenterY = (mapHeightInTiles * tileSize / 2f) / ToadsOdyssey.PPM;
//
//        // Set the camera's position
//        camera.position.set(playerX * PPM, mapCenterY * PPM, 0); // Convert world units to pixel units by multiplying with PPM
//
//        // Update the camera
//        camera.update();
//    }
